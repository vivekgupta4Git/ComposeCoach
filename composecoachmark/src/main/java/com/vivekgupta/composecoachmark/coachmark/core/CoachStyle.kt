...
interface  CoachStyle {
     ...
     * @param contentScope The [androidx.compose.foundation.layout.BoxWithConstraintsScope] for placing the buttons within the coach's content area.
     * @param targetBounds The [androidx.compose.ui.geometry.Rect] representing the target element that the coach is highlighting.
     ...
     *@param drawScope The [androidx.compose.ui.graphics.drawscope.DrawScope] providing functions for drawing shapes, paths, text, and other visual elements.
     *@return [Rect] return the rectangle generated by CoachShape !
     */
